...
ROOT_COORDINATOR_AGENT = AgentDefinition(
    ...
    rules=[
        ...
        "If verification fails after a write, do not auto-rollback or auto-rewrite; explain that the change was written but validation did not pass.",
...
WORKER_AGENT = AgentDefinition(
    ...
    allowed_tools=["file_read", "code_search", "todo_read", "todo_write", "replace_in_file", "file_write", "shell"],
    default_model="openai-compatible-default",
    max_tool_rounds=6,
    role="worker",
    can_delegate=False,
